...
test('all eight seeds depend only on wallet balance, including the ultimate',()=>{
...
test('wallet helper finds affordable tiers while squirrels use the garden selection',()=>{
 for(const [coins,tier] of [[0,0],[49,0],[50,1],[499,1],[500,2],[10000,3],[500000,4],[50000000,5],[10000000000,6]]){const s=newGame();s.coins=coins;assert.equal(highestSeed(s),tier)}
