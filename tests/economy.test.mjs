...
test('automatic sowing chooses the best affordable tier rather than falling straight to free seeds',()=>{
 ...
 let s=reducer(newGame(),{type:'start'});s.coins=1000;s=employ(s,'sow');s.coins=300
