...
function fixture(late:boolean,weather:number){
 ...
 if(!late){s.coins=10000;s.pots[0]={plant:8,growth:0,germination:5,variant:1,wateredAt:-10};return s}
 s.coins=1e16;s.earned=1e10;s=reducer(s,{type:'expand'})
 ...
 s.pots=s.pots.map((p,i)=>{const id=i%21===9?10:i%21;return {...p,variant:i%4,plant:id,growth:PLANTS[id].seconds*.7,germination:5}});return s
}
