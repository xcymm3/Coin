...
import {newGame,reducer,PLANTS,parseSave,DECORATIONS,teamFor} from '../src/game.ts'
...
test('fertilizer drops only on a real harvest, at about one percent, including carriers',()=>{
 ...
 s=start();s.coins=195;s=reducer(s,{type:'hire',id:'recruit-harvest-1'});s.extraRandom=1972;s.pots[0]=pot(0,30);teamFor(s).workers.harvest[0]={...teamFor(s).workers.harvest[0],phase:'act',target:0,clock:0,x:12,y:33}
