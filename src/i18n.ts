...
const zh = {
  data: {
    ...
    weather: {names:['细雨','萤火虫之夜','彩虹'],effects:['自然成长 ×2','收获收益 ×7','浇水成长 ×2']},
  ...
  dynamic: {
    ...
    seedPrice:'{{amount}} 金币', harvestedCount:'{{count}} / 4 已收获', waterToolTitle:'水壶 · 无限使用。点击选择后给植物浇水。', waterToolLabel:'水壶工具 · 无限使用',
  ...
  research: {harvest:'丰收研究 {{level}}级',soil:'沃土研究 {{level}}级',infusion:'灌注研究 {{level}}级',soilDetail:'本次升级：生长速度 ×2',infusionDetail:'本次升级：浇水成长 ×2'},
  ...
  help: {
    ...
    note:'装饰仅改变本园外观，高级花园价格更高；购买后可在设置中隐藏。每隔 5–10 分钟出现一次细雨、萤火虫之夜或彩虹，持续 15 秒：细雨使全园植物自然成长速度翻倍；萤火虫之夜使手动和自动收获收益 ×7，按采摘时刻结算；彩虹使手动和蜗牛浇水的成长效果 ×2。星之花不会被自动收获或自动播种。可关闭自动收获，保留喜欢的植物观赏。所有浇水只作用于单株植物。观赏模式保留音乐和自动照料，隐藏数值提示与通关弹窗。', done:'知道了',
  },
...
const en = {
  ...
  data: {
    ...
    weather: {names:['Soft Rain','Firefly Night','Rainbow'],effects:['Natural growth ×2','Harvest value ×7','Watering growth ×2']},
  ...
  dynamic: {
    ...
    seedPrice:'{{amount}} coins', harvestedCount:'{{count}} / 4 harvested', waterToolTitle:'Watering can · unlimited use. Select it, then water a plant.', waterToolLabel:'Watering can · unlimited use',
  ...
  research: {harvest:'Harvest Study Lv. {{level}}',soil:'Soil Study Lv. {{level}}',infusion:'Infusion Study Lv. {{level}}',soilDetail:'This upgrade: growth speed ×2',infusionDetail:'This upgrade: watering growth ×2'},
  ...
  help: {
    ...
    waterTitle:'Water and harvest', water:'A seed and a tool can stay selected together: empty pots sow, occupied pots use the chosen tool. The watering can has unlimited uses. Its extra growth is added gradually to the plant’s normal growth bar during the 1.2-second watering action, when that plant cannot be watered again. Mature plants are clearly marked and can be harvested for coins.',
    ...
    note:'Weather visits every 5–10 minutes for 15 seconds. Soft Rain doubles natural growth, Firefly Night multiplies harvest value by seven, and Rainbows double watering growth. Menus pause the garden; autosave and offline growth are enabled.', done:'Got it',
  },
