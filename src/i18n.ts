...
const en = {
  ...
  help: {
    ...
    waterTitle:'Water and harvest', water:'A seed and a tool can stay selected together: empty pots sow, occupied pots use the chosen tool. The watering can has unlimited uses, and each watering immediately advances the plant’s growth bar before a short per-plant cooldown. Mature plants are clearly marked and can be harvested for coins.',
