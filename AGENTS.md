...
6. If and only if the frozen `delivery-plan.json` contains explicit actions, run the optional `deliver` phase after PASS and require its checked postconditions before completion.
...
- `.codex/agents/task-deliverer.toml`
